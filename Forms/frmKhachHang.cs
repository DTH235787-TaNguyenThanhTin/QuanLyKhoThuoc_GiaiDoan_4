...
namespace QuanLyKhoThuoc.Forms
{
    public partial class frmKhachHang : Form
    {
        ...
        {
            string sql = "SELECT _maKhachHang, _hoTen, _diaChi, _dienThoai FROM KhachHang";
        ...
        private void btnLuu_Click(object sender, EventArgs e)
        {
            ...
            if (isAdding)
            {
                sql = $"INSERT INTO KhachHang (_maKhachHang, _hoTen, _diaChi, _dienThoai) VALUES ('{txtMaKhachHang.Text}', N'{txtTenKhachHang.Text}', N'{txtDiaChi.Text}', '{txtSDT.Text}')" +
                     $"SELECT * FROM KhachHang WHERE _maKhachHang = '{txtMaKhachHang.Text}'"; // Trả về bản ghi vừa thêm
            }
            else
            {
                sql = $"UPDATE KhachHang SET _hoTen = N'{txtTenKhachHang.Text}', _diaChi = N'{txtDiaChi.Text}', _dienThoai = '{txtSDT.Text}' WHERE _maKhachHang = '{txtMaKhachHang.Text}'";
            }
